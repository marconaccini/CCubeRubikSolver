...
*
* DESCRIPTION :
*       Base.h is a base data for Rubik Cube, like coordinates
*       axis rotation and Singmaster representation.
* 
*       The assumption for coordinates is:
*       - along X axis there are white (forward) anc yellow (backward) fases 
*       - along Y axis there are blue (right) anc green (left) fases 
*       - along Z axis there are orange (top) anc red (down) fases 
*
