...
void Test2_CubeCreate(void )
{
    ...
    printf("Color of tile with 'x' orientation of piece (1,0,1) is %s \n", 
        color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Fw, Y_Md, Z_Up, z_ax)));
    printf("Color of tile with 'y' orientation of piece (0,-1, -1) is %s \n", 
        color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Md, Y_Lf, Z_Dw, y_ax)));
    printf("Color of tile with 'z' orientation of piece (0,-1, -1) is %s \n", 
        color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Md, Y_Lf, Z_Dw, z_ax)));
    ...
    color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Fw, Y_Rg, Z_Up, x_ax)),
    color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Fw, Y_Rg, Z_Up, y_ax)),
    color2string(clr, get_color_of_piece_of_cube_by_orientation(q, X_Fw, Y_Rg, Z_Up, z_ax))
    );
    printf("Bingo !\n\n");
...
void Test5_CubeRotate(void)
{
    ...
    printf("The Orange face of the new cube is: \n");
    get_cube_face(& f, q, Or);
    face_print(f);
    
    cube_rotate_Singmaster(& q, F_rot); // rotation of white face clockwhise
    printf("The Orange face after an F rotation is: \n");
    face_print(* get_cube_face(& f, q, Or));
    
    cube_rotate_Singmaster(& q, L_rot); // rotation of blu face clockwhise
    printf("The Orange face after an L rotation is: \n");
    get_cube_face(& f, q, Or);
    face_print(f);
    
    cube_rotate_Singmaster(& q, Lp_rot); // rotation of blu face counter clockwhise
    printf("The Orange face after an L' rotation is: \n");
    get_cube_face(& f, q, Or);
    face_print(f);
    
    cube_rotate_Singmaster(& q, Fp_rot); // rotation of white face counter clockwhise
    printf("The Orange face after an Fp rotation is: \n");
    get_cube_face(& f, q, Or);
    face_print(f);
}
